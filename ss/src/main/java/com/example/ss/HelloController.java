...
// 将数据加载到 TableView 中
    ...
    private void initialize() {
        ...
        txtNum.textProperty().addListener((observableValue, s, t1) -> {
            btnInsert.setDisable(t1.trim().isEmpty());
        });
...
//使用系统确认框询问
        ...
        alert.setHeaderText("您确定要删除选中的消费者信息吗？");
// 显示对话框，并等待按钮返回
