...
public class StudentDaoImpl implements JdbcOperation<Student, Integer> {
    ...
    public void insert(Student entity) {
        try (Connection connection = JDBCUtil.getConnection();
             PreparedStatement preparedStatement = connection.prepareStatement("INSERT INTO ph VALUES (?,?,?,?,?)")) {
    ...
    public void update(Student entity, String primaryKey) {
        try (Connection connection = JDBCUtil.getConnection();
             PreparedStatement preparedStatement = connection.prepareStatement(
                     "UPDATE ph SET name=?, date=?, sex=?, phone=? WHERE sno=?")) {
    ...
    public List<Student> queryAll() {
        ...
        try (Connection connection = JDBCUtil.getConnection();
             ...
             ResultSet resultSet = statement.executeQuery("SELECT * FROM ph")) {
    ...
    public List<Student> searchByCondition(String sno, String name, String sex, String date, String phone) {
        ...
        try (Connection connection = JDBCUtil.getConnection();
             PreparedStatement preparedStatement = connection.prepareStatement(
                     "SELECT * FROM ph where sno like ? and name like ? and sex like ? and date like ? and phone like ?")) {
